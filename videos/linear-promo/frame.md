...
colors:
  # HAND-FIXED after build-frame.mjs: the auto-remix swapped luminance roles
  # (it produced a light bg / dark text) and mapped text-muted to the
  # saturated accent instead of a neutral gray. Linear's brand is a dark
  # canvas with light text and one violet accent, corrected below.
  bg: "#08090A"
  primary: "#5E6AD2"
  text: "#F7F8F8"
  text-muted: "#8A8F98"
  text-light: "#5B5F66"
  accent-light: "rgba(94, 106, 210, 0.14)"
  accent-medium: "rgba(94, 106, 210, 0.22)"
  border: "rgba(94, 106, 210, 0.28)"
  card-bg: "rgba(94, 106, 210, 0.08)"
  positive: "#059669"
  negative: "#dc2626"
