// Deterministic WAV bed for the "$200 BILLION" kinetic-scale slam.
...
//   0.00-0.52s  low rising tension (sub swell) under the punch-in
//   0.52s (f13) SUB-BOOM — bound to the overshoot/shake, VO "$200 billion"
//   0.52-4.30s  weighty resonant decay into a somber sustained bed
...
const BOOM_T = 13 / 24; // 0.5417s — the sync frame
