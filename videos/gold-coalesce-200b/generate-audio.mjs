// Deterministic WAV bed for the "$200,000,000,000" shatter-coalesce.
...
//   0.00-1.50s  rising shimmer/tension as the fragments converge
//   1.50s (f36) SUB-BOOM — bound to the solidify, VO "$200 billion"
//   1.50-4.30s  weighty resonant decay into a somber sustained bed
...
const BOOM_T = 36 / 24; // 1.5s — solidify / sync frame
